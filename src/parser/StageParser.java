// $ANTLR 3.4 /Users/marc/IdeaProjects/Stage/src/parser/Stage.g 2014-05-12 21:27:34
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public final StageParser.func_return func() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: FUNCTION, params, function_block_instructions, ret, nam
        ...
        try {
            ...
            switch (alt18) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: ID, ID, inputlist, expr_list
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
    ...
    public final StageParser.addFilter_return addFilter() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: ADDFILT, filtercall, ID
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
